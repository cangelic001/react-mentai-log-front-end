...
const NavBarT = () => {
  ...
  return (
    <nav className="bg-yellow-400 dark:bg-yellow-400 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-yellow-400 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-yellow-400 dark:bg-yellow-400 md:dark:bg-yellow-400 dark:border-yellow-500">
                <li className="text-white"><Link to='/'>Home</Link></li>
                <li className="text-white"><Link to='#'>Create a Log</Link></li>
                <li className="text-white"><Link to='#'>My Dashboard</Link></li>
            </ul>
            </div>
        </div>
    </nav>
